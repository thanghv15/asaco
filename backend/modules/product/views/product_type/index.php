    ...
    <table class="table table-striped table-bordered">
        <thead>
            <tr>
                ...
                <th class="text-center text-headerOptions"><a href="#">Mã </a></th>
                <th class="text-center text-headerOptions"><a href="#">Hiển thị</a></th>
        ...
        <?php foreach ($list_cate as $key => $value) { ?>
            <tr data-key="105">
                ...
                <td class="word-wrap-new" style="width:20%;"><?= $value[8] ?> </td>
                <td class="word-wrap-new text-center" style="width:10%;"><?= ($value[5] == 1) ?  '<span class="label label-success">Có</span>' :  '<span class="label label-danger">Không</span>';  ?></td>
