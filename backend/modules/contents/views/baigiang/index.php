...
/* @var $searchModel backend\modules\contents\models\BaigiangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Quản lý bài giảng';
$this->params['breadcrumbs'][] = $this->title;
$compoment = new ComponentBase();
$base_url = $compoment->Base_url();
?>
<div class="baigiang-index">
    <div>
    ...
    $(document).ready(function () {
        ...
        $(".confirm_delete_btn").click(function(){
            ...
            if (id_delete) 
            {
                $.ajax({
                    method: 'POST',
                    url: '<?php echo $base_url ?>contents/baigiang/delete',
                    ...
                    success: function(result){
                        if (result == 'success') 
                        {
                            ...
                            $("#modal-success_delete").modal("hide");
                                location.replace('<?php echo $base_url ?>contents/baigiang');
                            }, 2000);
