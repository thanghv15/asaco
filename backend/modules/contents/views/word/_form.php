...
<div class="word-form">
   ...
   <?= $form->field($model, 'url',['options' => ['class' => 'col-xs-12  padding-left-0 ']])->textInput(['maxlength' => true]) ?>
    <?php 
    // if($model->isNewRecord){
    //      $form->field($model, 'url')->fileInput(['class'=>'filestyle','data-icon'=>'false', 'data-buttonText'=>'Chọn tệp','data-classInput'=>'input-small','data-buttonBefore'=>"true"])->label('Tải lên tài liệu (*)');  

    //  }else{ 
    //     $form->field($model, 'url')->fileInput(['class'=>'filestyle', 'data-placeholder'=> $model->url,'data-icon'=>'false', 'data-buttonText'=>'Chọn tệp','data-classInput'=>'input-small','data-buttonBefore'=>"true"])->label('Tải lên tài liệu (*)'); 
    // }  
    ?>
