...
/* @var $searchModel backend\modules\contents\models\WordSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Quản lý giáo án Word';
    ...
    $(document).ready(function () {
        ...
        $(".confirm_delete_btn").click(function(){
            ...
            if (id_delete) 
            {
                $.ajax({
                    method: 'POST',
                    url: '<?php echo $base_url ?>contents/word/delete',
