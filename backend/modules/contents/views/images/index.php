    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'value' => function ($row) {
                    $components = new ComponentBase();
                    $url_image = $components->Base_url_images();
                    return '<img src="'.$url_image.$row['url'].'" alt="" height="50" width="50">';
                },
            ],
            [
                'attribute' => 'authors',
        ...
        $(".confirm_delete_district_btn").click(function(){
            $("#confirm_delete_district_modal").modal("hide");
                ...
                if (id_delete) 
                {
                    $.ajax({
                        method: 'POST',
                        url: '<?php echo $base_url ?>contents/images/delete',
                        ...
                        success: function(result){
                            if (result == 'success') 
                            {
                                ...
                                $("#modal-success_delete").modal("hide");
                                    location.replace('<?php echo $base_url ?>contents/images');
                                }, 2000);
