...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="<?= $base_url ?>" class="logo">
          ...
          <span class="logo-lg"><b>Tuổi Hoa</b></span>
        </a>
    ...
    <aside class="main-sidebar" >
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <!-- <li class="treeview">
                    <a href="#">
                        <i class="fa fa-desktop"></i> <span>Quản lý bán hàng</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li id="salemanager_orders"><a href="<?php echo  $base_url ?>salemanager/orders"><i class="fa fa-circle-o"></i>Quản lý đơn hàng</a></li>
                        <li id="salemanager_district"><a href="#"><i class="fa fa-circle-o"></i>Quản lý xuất hàng</a></li>
                        <li id="salemanager_maker"><a href="#"><i class="fa fa-circle-o"></i>Quản lý chứng thư</a></li>
                        <li id="salemanager_saleoff"><a href="<?php echo  $base_url ?>salemanager/saleoff"><i class="fa fa-circle-o"></i>Chương trình khuyến mãi</a></li>
                    </ul>
                </li> -->
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li id="product_product_type"><a href="<?php echo  $base_url ?>product/product_type"><i class="fa fa-circle-o"></i>Danh mục menu</a></li>
                    </ul>
                </li> 
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-table"></i> <span>Quản lý nội dung</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li id="content"><a href="<?php echo $base_url.'contents/baigiang'?>"><i class="fa fa-circle-o"></i>Quản lý bài giảng </a></li>
                        <li id="content"><a href="<?php echo $base_url.'contents/video'?>"><i class="fa fa-circle-o"></i>Quản lý video </a></li>
                        <li id="content"><a href="<?php echo $base_url ?>contents/music"><i class="fa fa-circle-o"></i>Quản lý âm nhạc </a></li>
                        <li id="content"><a href="<?php echo $base_url ?>contents/images"><i class="fa fa-circle-o"></i>Quản lý hình ảnh </a></li>
                        <li id="contents_word"><a href="<?php echo  $base_url ?>contents/word"><i class="fa fa-circle-o"></i>Quản lý giáo án word </a></li>
                        <li id="contents_game"><a href="<?php echo  $base_url ?>contents/game"><i class="fa fa-circle-o"></i>Quản lý trò chơi </a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <!-- <li id="systems_sysconfig"><a href="<?php echo $base_url ?>systems/sysconfig"><i class="fa fa-circle-o"></i>Cấu hình</a></li> -->
